...
// number
// c1 dư thừa khai báo vì khi gán tyscipt tự hiểu
let num:number
num = 150
// c2
let nums = 10
...
let state: State = {      // Bằng 2 cái trên gộp lại
  name:'zyzy',
  isLoading:true,
  age: 20
}
...
/**
 * Type có thể union, có thể gộp lại
 */
type States = {
  name: string
  isLoading: boolean
...
// alex.name    //sai do name đã bị private
alex.age
alex.money
