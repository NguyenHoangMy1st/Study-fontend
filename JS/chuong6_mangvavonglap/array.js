...
const students1 = ["zy", "my", "tom", "ngien", "dat", "zy"]; //0 1 2 3 4
// index : vị trí của phần tủ hay giá trị trong mảng và nó bắt đầu từ 0
...
console.log(students1.includes("my")); //true
...
console.log(students1.lastIndexOf("zy")); //5
