...
window.addEventListener(
  ...
  // 3.window.pageYOffset là khoảng cách của scroll theo cửa window theo chiều dọc so với phía trên cùng
  //   window.pageXOffset là khoảng cách của scroll theo cửa window theo chiều ngang so với phía bên trái
