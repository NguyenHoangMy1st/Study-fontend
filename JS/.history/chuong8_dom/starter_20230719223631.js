...
const randomTitle = ["Welcome to Js", "Welcome to Notification", "Xin chào", "Today is a good day"];
createNotification();
const timer = setInterval(function(){
    ...
    const title = randomTitle[Math.floor.random() * randomTitle.length]
    createNotification("welcome evondev");
}, 4000);
