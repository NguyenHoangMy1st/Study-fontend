...
// 2.3 document.getElementsByClassName("classname") -> trả về một HTMLCollection chứa danh sách các node, ngược lại trả về empty
const classNodes = document.getElementsByClassName("item");
console.log(classNodes);
console.log("--------------------------------------------------");

// 2.4 document.getElementsByTagName("tagname") -> trả về một HTMLCollection chứa danh sách các node, ngược lại trả về empty
const tagNodes = document.getElementsByTagName("li");
console.log(tagNodes);
console.log("--------------------------------------------------");

// 2.5 document.getElementByID("id") -> trả về 1 node, ngược lại trả về null
const idNode = document.getElementById("spinner");
console.log(idNode);
console.log("--------------------------------------------------");

// tổng kết: hay dùng nhất là document.querySelector(tag, class, id) và document.querySelectorAll(tag, class)
